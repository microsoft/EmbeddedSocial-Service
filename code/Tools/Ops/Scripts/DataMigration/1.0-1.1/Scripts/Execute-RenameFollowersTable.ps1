#
# Execute-RenameFollowersTable.ps1
#
# This script executes RenameFollowersTable pipeline using the specified Environment name
...
#
# Example Usage
# Execute-RenameFollowersTable -Name "sp-dev-test1"
#

function Execute-RenameFollowersTable
{
    <#
    .NOTES
       Name: Execute-RenameFollowersTable.ps1
       Requires: Azure PowerShell version 2.1 or higher with Azure subscription loaded.
    .SYNOPSIS
       Executes RenameFollowersTable pipeline using the specified Environment name.
    .DESCRIPTION
       This script executes RenameFollowersTable pipeline using the specified Environment name. 
       The environment name without hyphens is used to identify the names of the resources/assets created as part of data factory.	   
    .PARAMETER Name
    ...
    process
    {
        ...
        $file = Get-Item $relativePath"\RenameFollowersTable.json"
