#
# Execute-UpdateUsersTable.ps1
#
# This script executes UpdateUsersTable pipeline using the specified Environment name
...
#
# Example Usage
# Execute-UpdateUsersTable -Name "sp-dev-test1"
#

function Execute-UpdateUsersTable
{
    <#
    .NOTES
       Name: Execute-UpdateUsersTable.ps1
       Requires: Azure PowerShell version 2.1 or higher with Azure subscription loaded.
    .SYNOPSIS
       Executes UpdateUsersTable pipeline using the specified Environment name.
    .DESCRIPTION
       This script executes UpdateUsersTable pipeline using the specified Environment name. 
       The environment name without hyphens is used to identify the names of the resources/assets created as part of data factory.	   
    .PARAMETER Name
    ...
    {	
        ...
        $file = Get-Item $relativePath"\UpdateUsersTable.json"
