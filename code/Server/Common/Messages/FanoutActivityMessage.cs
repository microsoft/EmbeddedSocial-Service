// <copyright file="FanoutActivityMessage.cs" company="Microsoft">
...
namespace SocialPlus.Server.Messages
{
    ...
    /// <summary>
    /// <c>Fanout</c> activity message
    /// </summary>
    public class FanoutActivityMessage : QueueMessage, IFanoutActivityMessage
    {
        /// <summary>
