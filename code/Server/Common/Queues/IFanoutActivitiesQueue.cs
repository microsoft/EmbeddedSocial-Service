// <copyright file="IFanoutActivitiesQueue.cs" company="Microsoft">
...
namespace SocialPlus.Server.Queues
{
    ...
    /// <summary>
    /// <c>Fanout</c> activities queue interface
    /// </summary>
    public interface IFanoutActivitiesQueue : IQueueBase
    {
        /// <summary>
        ...
        Task SendFanoutActivityMessage(
            string userHandle,
            string appHandle,
        ...
        /// <param name="createdTime">Created time</param>
        /// <returns>Send message task</returns>
        Task SendFanoutTopicActivityMessage(
            string topicHandle,
            string appHandle,
            string activityHandle,
            ActivityType activityType,
